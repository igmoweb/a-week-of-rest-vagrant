...
PHP
    ...
    noroot wp plugin install rest-api --activate
    noroot wp plugin install https://github.com/WP-API/OAuth1/archive/master.zip --activate
    noroot wp plugin install https://github.com/WP-API/broker-client/archive/master.zip --activate

  else
    echo "Updating WordPress Stable..."
    cd /srv/www/wordpress-default
    noroot wp core upgrade
    noroot wp plugin upgrade rest-api
  fi
}
...
# Time for WordPress!
echo " "
echo "Installing/updating WordPress Stable"
